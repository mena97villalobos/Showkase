...
public val TestComposablegroupname: ShowkaseBrowserComponent = ShowkaseBrowserComponent(
        ...
        componentName = "name",
        componentKDoc = "",
    componentKey = """com.airbnb.android.showkase_processor_testing.Composables_TestComposable_com.airbnb.android.showkase_processor_testing.Composables_group_name_0_null""",
        isDefaultStyle = false,
        screenshotConfig = ScreenshotConfig.SingleStaticImage,
        component = @Composable {
            Composables().TestComposable()
        }
    )
