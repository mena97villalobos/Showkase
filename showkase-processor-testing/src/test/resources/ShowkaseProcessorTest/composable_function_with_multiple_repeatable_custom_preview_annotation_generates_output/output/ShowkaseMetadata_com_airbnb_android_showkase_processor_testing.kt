...
public class ShowkaseMetadata_com_airbnb_android_showkase_processor_testing {
  ...
  @ShowkaseCodegenMetadata(
    ...
    insideWrapperClass = false,
    showkaseKDoc = "",
    generatedPropertyName = "HelloWorldPreviewthemesHelloWorldPreviewlighttheme1",
    showkaseMetadataType = "COMPONENT",
    isDefaultStyle = false,
  )
  public fun comairbnbandroidshowkaseprocessortestingHelloWorldPreviewthemesHelloWorldPreviewlighttheme1() {
  }
}
