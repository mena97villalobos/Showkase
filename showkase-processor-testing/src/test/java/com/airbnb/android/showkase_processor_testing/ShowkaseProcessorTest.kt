...
class ShowkaseProcessorTest : BaseProcessorTest() {
    ...
    fun `open class with no interface but ShowkaseScreenshoTest annotation throws compilation error`() {
        assertCompilationFails(
            "Only an implementation of com.airbnb.android.showkase.screenshot.testing.ShowkaseScreenshotTest or com.airbnb.android.showkase.screenshot.testing.roborazzi.RoborazziShowkaseScreenshotTest can be annotated with @ShowkaseScreenshot"
        )
    }
